...
export declare class PieGridSeriesComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PieGridSeriesComponent, "g[ngx-charts-pie-grid-series]", never, { "colors": "colors"; "data": "data"; "innerRadius": "innerRadius"; "outerRadius": "outerRadius"; "animations": "animations"; }, { "select": "select"; "activate": "activate"; "deactivate": "deactivate"; }, never, never, false>;
}
