...
export declare class BoxSeriesComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BoxSeriesComponent, "g[ngx-charts-box-series]", never, { "dims": "dims"; "series": "series"; "xScale": "xScale"; "yScale": "yScale"; "colors": "colors"; "animations": "animations"; "strokeColor": "strokeColor"; "strokeWidth": "strokeWidth"; "tooltipDisabled": "tooltipDisabled"; "tooltipTemplate": "tooltipTemplate"; "tooltipPlacement": "tooltipPlacement"; "tooltipType": "tooltipType"; "roundEdges": "roundEdges"; "gradient": "gradient"; }, { "select": "select"; "activate": "activate"; "deactivate": "deactivate"; }, never, never, false>;
}
