...
export declare class BoxComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BoxComponent, "g[ngx-charts-box]", never, { "strokeColor": "strokeColor"; "strokeWidth": "strokeWidth"; "fill": "fill"; "data": "data"; "width": "width"; "height": "height"; "x": "x"; "y": "y"; "lineCoordinates": "lineCoordinates"; "roundEdges": "roundEdges"; "gradient": "gradient"; "gradientStops": "gradientStops"; "offset": "offset"; "isActive": "isActive"; "animations": "animations"; "ariaLabel": "ariaLabel"; "noBarWhenZero": "noBarWhenZero"; }, { "select": "select"; "activate": "activate"; "deactivate": "deactivate"; }, never, never, false>;
}
export {};
