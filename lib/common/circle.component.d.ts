...
export declare class CircleComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CircleComponent, "g[ngx-charts-circle]", never, { "cx": "cx"; "cy": "cy"; "r": "r"; "fill": "fill"; "stroke": "stroke"; "data": "data"; "classNames": "classNames"; "circleOpacity": "circleOpacity"; "pointerEvents": "pointerEvents"; }, { "select": "select"; "activate": "activate"; "deactivate": "deactivate"; }, never, never, false>;
}
