...
export declare class SvgRadialGradientComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SvgRadialGradientComponent, "g[ngx-charts-svg-radial-gradient]", never, { "color": "color"; "name": "name"; "startOpacity": "startOpacity"; "endOpacity": "endOpacity"; "cx": "cx"; "cy": "cy"; "stops": "stops"; }, {}, never, never, false>;
}
