...
export declare class GridPanelSeriesComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GridPanelSeriesComponent, "g[ngx-charts-grid-panel-series]", never, { "data": "data"; "dims": "dims"; "xScale": "xScale"; "yScale": "yScale"; "orient": "orient"; }, {}, never, never, false>;
}
export {};
