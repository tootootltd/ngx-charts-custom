...
export declare class HeatMapCellComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<HeatMapCellComponent, "g[ngx-charts-heat-map-cell]", never, { "fill": "fill"; "x": "x"; "y": "y"; "width": "width"; "height": "height"; "data": "data"; "gradient": "gradient"; "animations": "animations"; }, { "select": "select"; "activate": "activate"; "deactivate": "deactivate"; }, never, never, false>;
}
