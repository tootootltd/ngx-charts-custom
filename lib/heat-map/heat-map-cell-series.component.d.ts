...
export declare class HeatCellSeriesComponent implements OnChanges, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<HeatCellSeriesComponent, "g[ngx-charts-heat-map-cell-series]", never, { "data": "data"; "colors": "colors"; "xScale": "xScale"; "yScale": "yScale"; "gradient": "gradient"; "tooltipDisabled": "tooltipDisabled"; "tooltipText": "tooltipText"; "tooltipTemplate": "tooltipTemplate"; "animations": "animations"; }, { "select": "select"; "activate": "activate"; "deactivate": "deactivate"; }, never, never, false>;
}
export {};
