...
export declare class PolarSeriesComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PolarSeriesComponent, "g[ngx-charts-polar-series]", never, { "name": "name"; "data": "data"; "xScale": "xScale"; "yScale": "yScale"; "colors": "colors"; "scaleType": "scaleType"; "curve": "curve"; "activeEntries": "activeEntries"; "rangeFillOpacity": "rangeFillOpacity"; "tooltipDisabled": "tooltipDisabled"; "tooltipText": "tooltipText"; "gradient": "gradient"; "tooltipTemplate": "tooltipTemplate"; "animations": "animations"; }, { "select": "select"; "activate": "activate"; "deactivate": "deactivate"; }, never, never, false>;
}
export {};
