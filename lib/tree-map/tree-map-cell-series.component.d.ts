...
export declare class TreeMapCellSeriesComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TreeMapCellSeriesComponent, "g[ngx-charts-tree-map-cell-series]", never, { "data": "data"; "dims": "dims"; "colors": "colors"; "valueFormatting": "valueFormatting"; "labelFormatting": "labelFormatting"; "gradient": "gradient"; "tooltipDisabled": "tooltipDisabled"; "tooltipTemplate": "tooltipTemplate"; "animations": "animations"; }, { "select": "select"; }, never, never, false>;
}
export {};
